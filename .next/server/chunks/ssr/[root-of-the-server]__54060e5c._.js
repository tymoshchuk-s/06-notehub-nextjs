...
"[project]/.next-internal/server/app/notes/page/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
const fetchNotes = async (search, page)=>{
    ...
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/notes`, {
        params,
        headers
    });
...
const fetchNoteById = async (id)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].get(`${BASE_URL}/notes/${id}`, {
        headers
    });
    return response.data;
};
const createNote = async (note)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].post(`${BASE_URL}/notes`, note, {
        headers: {
            ...headers,
...
const deleteNote = async (id)=>{
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["default"].delete(`${BASE_URL}/notes/${id}`, {
        headers
    });
    return response.data;
};
...
async function NotesPage() {
    ...
    await queryClient.prefetchQuery({
        ...
        queryFn: ()=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchNotes"])(search, page)
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54060e5c._.js.map